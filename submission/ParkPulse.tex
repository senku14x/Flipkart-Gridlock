...
\begin{itemize}[label=\textbullet]
  \item \textbf{No ground truth for impact.} The score is an engineered index, not a measurement; we validate by face validity and stability, never by claimed accuracy.
